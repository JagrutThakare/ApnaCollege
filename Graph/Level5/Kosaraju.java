...
/*  
    Time complexity: O(n * (n + m)), because for each pair of vertices 
    we are checking whether a path exists between them.
...
public class Kosaraju {
    ...
    public static void main(String[] args) {
        ...
        List<List<Integer>> ans = findSCC(V, edges);
    ...
    static boolean dfs(int curr, int des, List<List<Integer>> adj,
                List<Integer> vis) {
    ...
    // destination
    static boolean isPath(int src, int des, List<List<Integer>> adj) {
    ...
    static List<List<Integer>> findSCC(int n, List<List<Integer>> a) {
